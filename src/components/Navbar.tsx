  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/90 transition-all shadow-xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-2.5 sm:py-3.5 gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            ...
            >
              <Logo variant="dark" size="lg" className="h-[56px] sm:h-[70px] w-auto" />
            </button>
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
            ...
            <button
              onClick={onOpenQuote}
              className="inline-flex items-center gap-1.5 px-3.5 sm:px-4 py-2 text-xs font-bold uppercase tracking-wider text-white bg-[#0A66C2] hover:bg-[#004182] rounded-lg shadow-sm transition-all cursor-pointer whitespace-nowrap"
            >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-slate-200 bg-white px-4 pt-3 pb-6 space-y-2 shadow-xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="p-3.5 bg-slate-50 border border-slate-200/80 rounded-xl mb-3 flex flex-col items-center text-center gap-1.5 shadow-xs">
            <Logo variant="dark" size="md" className="h-[54px] w-auto" />
          ...
          <div className="pt-3 border-t border-slate-200 flex gap-2">
            <button
              ...
              className="flex-1 py-2.5 text-center text-xs font-bold text-[#0B192C] bg-slate-100 rounded-lg border border-slate-300"
            >
              Area Clienti Cloud
            </button>
            <button
